...
const ItemGenres: React.FC<ItemStrArrayProps> = ({ setStrArray, data }) => {
    ...
    <div className="accordion-item">
      ...
      <h2 className="accordion-header">
        <button
          ...
          data-bs-target="#genres-filters"
          aria-expanded="false"
          aria-controls="genres-filters"
        >
          Genres{" "}
